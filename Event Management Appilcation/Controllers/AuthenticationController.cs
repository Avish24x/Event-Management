    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        public async Task<IActionResult> ForgotPassword([Required] string email)
        {
            ...
            if (user != null)
            {
                ...
                _emailService.SendEmail(message);
                return StatusCode(StatusCodes.Status200OK,
                                       new Response { Status = "Success", Message = $"Reset Password Link has been sent to {user.Email} successfully.Please verify your Email." });
            }
            return StatusCode(StatusCodes.Status400BadRequest,
                                                      new Response { Status = "Error", Message = $"User with this Email does not exist." });
        }
        ...
        private JwtSecurityToken GetToken(List<Claim> authClaims)
        {
            ...
            var token = new JwtSecurityToken(
                ...
                // this will log out the user in 2 days 
