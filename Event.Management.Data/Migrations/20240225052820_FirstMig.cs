    ...
    public partial class FirstMig : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SDEventID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SDEvents", x => x.SDEventID);
                    table.ForeignKey(
                        name: "FK_SDEvents_Groups_groupTableGroupID",
                        column: x => x.groupTableGroupID,
                        principalTable: "Groups",
                        principalColumn: "GroupID");
                    table.ForeignKey(
                        name: "FK_SDEvents_Reports_ReportID",
                        column: x => x.ReportID,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserID = table.Column<int>(type: "int", nullable: true),
                    SDEventID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserEvents", x => x.UserEventID);
                    table.ForeignKey(
                        name: "FK_UserEvents_SDEvents_SDEventID",
                        column: x => x.SDEventID,
                        principalTable: "SDEvents",
                        principalColumn: "SDEventID");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SDEvents_groupTableGroupID",
                table: "SDEvents",
                column: "groupTableGroupID");

            migrationBuilder.CreateIndex(
                name: "IX_SDEvents_ReportID",
                table: "SDEvents",
                column: "ReportID");

            migrationBuilder.CreateIndex(
                name: "IX_UserEvents_SDEventID",
                table: "UserEvents",
                column: "SDEventID");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Feedbacks_SDEvents_EventID",
                table: "Feedbacks",
                column: "EventID",
                principalTable: "SDEvents",
                principalColumn: "SDEventID");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Groups_SDEvents_EventID",
                table: "Groups",
                column: "EventID",
                principalTable: "SDEvents",
                principalColumn: "SDEventID");
